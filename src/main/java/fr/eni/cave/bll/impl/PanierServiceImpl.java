...
public class PanierServiceImpl implements PanierService {
	...
	public List<Panier> chargerCommandes(String idClient) {
		...
		if (idClient == null) {
			throw new RuntimeException("idClient ne peux pas être null");
		}

		Client client = cRepository.findByPseudo(idClient);
		if (client == null) {
			throw new RuntimeException("Client n'existe pas");
		}

		return pRepository.findListCommandes(client);
	}
	...
	public List<Panier> chargerPaniersNonPayes(String idClient) {
		...
		return pRepository.findPaniersByClientAndNumCommandeIsNotNull(client);
	}
